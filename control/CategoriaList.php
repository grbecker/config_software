...
class CategoriaList {
    ...
    public function load() {
        try {            
            ...
            foreach ($categoria as $row) {                               
                ...
                $items .= "<td><a href=\"categoria-edit?id={$row["id"]}\"><i class=\"bi bi-pencil-square\"></i></a></td>";
                $items .= "<td><a href=\"categoria-delete?id={$row["id"]}\"><i class=\"bi bi-trash\"></i></a></td>";
                $items .= "</tr>";
            }
            $items .= "</tbody>" .
                      "</table>";
    ...
    public function show() {        
        ...
        $this->html = str_replace('{classe}', 'categoria' , $this->html);        
        return $this->html;
    }
